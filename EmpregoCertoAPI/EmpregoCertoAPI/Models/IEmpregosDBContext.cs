...
{
    public partial class IEmpregosDBContext : DbContext
    {
        public IEmpregosDBContext()
        {
        }

        public IEmpregosDBContext(DbContextOptions<IEmpregosDBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-788CHIO;Database=IEmpregosDB;Trusted_Connection=True;");
            }
        }
